...
class EmbeddingTools {
    ...
    companion object {
        ...
        private val CHECK_1 = String.format(
            "https://cdn.jsdelivr.net/gh/MineCraftGensoukyo/MCGImages@%s/img/Unembedding_Check_1.png",
            VERSION
        )
        private val CHECK_2 = String.format(
            "https://cdn.jsdelivr.net/gh/MineCraftGensoukyo/MCGImages@%s/img/Unembedding_Check_2.png",
            VERSION
        )
