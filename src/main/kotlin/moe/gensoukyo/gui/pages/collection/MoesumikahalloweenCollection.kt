...
class MoesumikahalloweenCollection : CollectionPage {
    private val imageRoot = "location:mcgproject:textures/gui"
    private val backgroundImage = "$imageRoot/collection_moesumikahalloween.png"
    ...
    override fun getLabel(container: Container) {
        WButton(
            container,
            "button_tage_moesumikahalloween",
            "§9§l时装",
            "$imageRoot/collection_tag_moesumikahalloween_1.png",
            "$imageRoot/collection_tag_moesumikahalloween_2.png",
            "$imageRoot/collection_tag_moesumikahalloween_2.png",
            0,
            0
        ).apply {
    ...
    override fun getPageID() = "collection_moesumikahalloween"
